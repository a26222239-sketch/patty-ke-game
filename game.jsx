...
const CLOTHING_DB = {
  top: [
    ...
    ['t5', '黑色綁帶深V馬甲',         36, 1200],
    ['t6', '黑紗透視長袖薄衫',          46, 1800],
    ['t7', '緋紅網紗透視短上衣',         58, 2500],
    ['t8', '黑皮革深開胸馬甲',         70, 3500],
    ['t9', '鏤空交叉綁帶露乳短衣',         84, 4800],
    ['t10','透明PVC濕亮罩衫',         99, 6500],
    ['t11','緋繩縛胸前繞繩衣',        116, 9000],
  ...
  bra: [
    ...
    ['b4', '純白蕾絲半罩內衣',           42, 1150],
    ['b5', '豹紋深V托高內衣',        56, 1700],
    ['b6', '黑色透明薄紗托胸衣',         72, 2500],
    ['b7', '緋紅蕾絲開口半罩杯',         90, 3600],
    ['b8', '黑皮革束胸半罩杯',        110, 4900],
    ['b9', '鏤空交叉綁帶胸衣',      132, 6800],
    ['b10','透明PVC半罩杯',         157, 9000],
    ['b11','緋繩繞頸細繩胸衣',        185,12500],
  ...
  bottom: [
    ...
    ['bt4', '純白蕾絲高衩短裙',          28,  800],
    ['bt5', '黑色皮革超短裙',            36, 1200],
    ['bt6', '黑紗透視開衩短裙',          46, 1800],
    ['bt7', '緋紅網紗透視短裙',          58, 2500],
    ['bt8', '黑皮革露臀開衩裙',          70, 3500],
    ['bt9', '鏤空綁帶高衩短裙',          84, 4800],
    ['bt10','透明PVC超短裙',         99, 6500],
    ['bt11','緋繩縛遮陰繞繩裙',     116, 9000],
  ...
  panties: [
    ...
    ['p5', '豹紋低腰丁字褲',         67, 1750],
    ['p6', '黑紗側綁透明三角褲',         85, 2500],
    ['p7', '緋紅透明蕾絲丁字褲',            105, 3500],
    ['p8', '黑皮革丁字褲',            127, 4750],
    ['p9', '鏤空綁帶式丁字褲',        152, 6500],
    ['p10','透明PVC開檔內褲',          179, 9000],
    ['p11','緋繩單線丁字褲',        209,12500],
  ...
  socks: [
    ...
    ['sk5', '黑色魚網大腿襪',        32, 1000],
    ['sk6', '黑色透膚過膝薄紗襪',        44, 1500],
    ['sk7', '緋紅後縫線大腿襪',        58, 2250],
    ['sk8', '黑皮革綁帶大腿襪',      74, 3250],
    ['sk9', '鏤空綁帶大腿高筒襪',      92, 4500],
    ['sk10','透明PVC濕亮大腿襪',       112, 6250],
    ['sk11','緋繩交叉綁腿大腿襪',   135, 8500],
  ...
  shoes: [
    ...
    ['sh6', '黑色漆皮繫踝細跟高跟',         56, 3000],
    ['sh7', '緋紅漆皮細跟高跟鞋',         72, 4250],
    ['sh8', '黑皮革繫踝細跟高跟',     90, 6000],
    ['sh9', '交叉綁帶纏繞細跟高跟',       110, 8250],
    ['sh10','透明PVC繫踝細跟高跟',      132,11000],
    ['sh11','緋繩纏繞繫踝細跟高跟',      156,15000],
