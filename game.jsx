...
import { SAVE_VERSION, HAIR_LEVELS, HAIR_LEVEL_KEYS, HAIR_PARTS, HAIR_PART_NAMES, HAIR_GROW_DAYS, CONDOM_PRICE, PIERCING_PRICES, TATTOO_SIZES, HAIR_TRIM_PRICE } from './src/constants.js'; // 全域常數（SECTION 2 已抽出）
