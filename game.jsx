...
// T11~T12 立繪待重新製作後再逐張接回；未備齊的高級暫時沿用最近的低級圖
// ── 紙娃娃（立繪分級）系統 ───────────────────────────────────────────
// 以「整套同級」對應一張全身立繪：主要服裝(上著/內衣/下著/內褲/襪子/鞋子)全部達第 N 級
// → 顯示第 N 級立繪（未備齊的高級先沿用最高現有圖）。初始造型(t1/b1/bt1/p1/sk1/sh1)=keyuT1。
const PORTRAIT_TIERS = { 1: keyuT1, 2: keyuT2, 3: keyuT3, 4: keyuT4, 5: keyuT5, 6: keyuT6, 7: keyuT7, 8: keyuT8, 9: keyuT9, 10: keyuT10 };
