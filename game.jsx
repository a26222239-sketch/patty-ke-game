...
import { CAT, CLOTHING_DB, CUPS, ENEMY_TIERS, LABOR_JOBS, REPUTATION_TITLES, SERVICE_NAMES, SERVICE_TO_CLOTHING, PIERCING_NAMES, TATTOO_LOCS, INITIAL_PLAYER } from './src/data.js'; // 資料表（SECTION 3-4 已抽出）
