...
import keyuT15 from '../keyu_t15.png'; // 立繪・全套第15級（牛仔休閒：黑交叉細肩帶背心/低腰丹寧牛仔短褲/黑透膚及膝襪/白繫踝瑪莉珍高跟）
...
const PORTRAIT_RULES = [
  // T15 牛仔休閒：交叉細肩帶背心+牛仔短褲+及膝襪+白繫踝高跟可見；內衣/內褲被遮 → 不檢
  { img: keyuT15, need: { top: 't14', bottom: 'bt14', socks: 'sk14', shoes: 'sh14' } },
